...
// ExtractorSummaryMetricsExecutionTime extractor summary metrics execution time
// swagger:model extractorSummaryMetricsExecutionTime
...
func (m *ExtractorSummaryMetricsExecutionTime) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ExtractorSummaryMetricsExecutionTime) UnmarshalBinary(b []byte) error {
	var res ExtractorSummaryMetricsExecutionTime
