...
// ExtractorSummaryMetricsTotalTime extractor summary metrics total time
// swagger:model extractorSummaryMetricsTotalTime
...
func (m *ExtractorSummaryMetricsTotalTime) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ExtractorSummaryMetricsTotalTime) UnmarshalBinary(b []byte) error {
	var res ExtractorSummaryMetricsTotalTime
