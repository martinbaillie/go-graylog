...
// InputStatesListStatesItemsMessageInput input states list states items message input
// swagger:model inputStatesListStatesItemsMessageInput
...
func (m *InputStatesListStatesItemsMessageInput) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *InputStatesListStatesItemsMessageInput) validateCreatedAt(formats strfmt.Registry) error {
...
func (m *InputStatesListStatesItemsMessageInput) UnmarshalBinary(b []byte) error {
	var res InputStatesListStatesItemsMessageInput
