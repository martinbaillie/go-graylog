...
// swagger:model CollectorSummary
...
func (m *CollectorSummary) validateLastSeen(formats strfmt.Registry) error {
...
func (m *CollectorSummary) validateNodeDetails(formats strfmt.Registry) error {
