...
// LdapSettingsResponse ldap settings response
// swagger:model LdapSettingsResponse
...
func (m *LdapSettingsResponse) validateAdditionalDefaultGroups(formats strfmt.Registry) error {
