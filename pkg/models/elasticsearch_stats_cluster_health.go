...
// ElasticsearchStatsClusterHealth elasticsearch stats cluster health
// swagger:model elasticsearchStatsClusterHealth
...
func (m *ElasticsearchStatsClusterHealth) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ElasticsearchStatsClusterHealth) validatePendingTasksTimeInQueue(formats strfmt.Registry) error {
...
func (m *ElasticsearchStatsClusterHealth) UnmarshalBinary(b []byte) error {
	var res ElasticsearchStatsClusterHealth
