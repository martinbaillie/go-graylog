...
// RetentionStrategyDescription retention strategy description
// swagger:model RetentionStrategyDescription
...
func (m *RetentionStrategyDescription) validateDefaultConfig(formats strfmt.Registry) error {
...
func (m *RetentionStrategyDescription) validateJSONSchema(formats strfmt.Registry) error {
...
func (m *RetentionStrategyDescription) UnmarshalBinary(b []byte) error {
	var res RetentionStrategyDescription
