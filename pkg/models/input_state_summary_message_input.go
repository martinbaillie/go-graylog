...
// InputStateSummaryMessageInput input state summary message input
// swagger:model inputStateSummaryMessageInput
...
func (m *InputStateSummaryMessageInput) validateCreatedAt(formats strfmt.Registry) error {
...
func (m *InputStateSummaryMessageInput) UnmarshalBinary(b []byte) error {
	var res InputStateSummaryMessageInput
