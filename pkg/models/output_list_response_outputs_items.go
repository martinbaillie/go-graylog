...
// OutputListResponseOutputsItems output list response outputs items
// swagger:model outputListResponseOutputsItems
...
func (m *OutputListResponseOutputsItems) validateCreatedAt(formats strfmt.Registry) error {
...
func (m *OutputListResponseOutputsItems) UnmarshalBinary(b []byte) error {
	var res OutputListResponseOutputsItems
