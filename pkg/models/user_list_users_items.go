...
// UserListUsersItems user list users items
// swagger:model userListUsersItems
...
func (m *UserListUsersItems) validateLastActivity(formats strfmt.Registry) error {
...
func (m *UserListUsersItems) validatePermissions(formats strfmt.Registry) error {
...
func (m *UserListUsersItems) validateRoles(formats strfmt.Registry) error {
...
func (m *UserListUsersItems) validateStartpage(formats strfmt.Registry) error {
