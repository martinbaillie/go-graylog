...
// ClusterConfigList cluster config list
// swagger:model ClusterConfigList
...
func (m *ClusterConfigList) validateClasses(formats strfmt.Registry) error {
