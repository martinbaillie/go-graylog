...
// RotationStrategiesStrategiesItemsJSONSchema rotation strategies strategies items Json schema
// swagger:model rotationStrategiesStrategiesItemsJsonSchema
...
func (m *RotationStrategiesStrategiesItemsJSONSchema) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *RotationStrategiesStrategiesItemsJSONSchema) validateDisallow(formats strfmt.Registry) error {
...
func (m *RotationStrategiesStrategiesItemsJSONSchema) validateExtends(formats strfmt.Registry) error {
...
func (m *RotationStrategiesStrategiesItemsJSONSchema) UnmarshalBinary(b []byte) error {
	var res RotationStrategiesStrategiesItemsJSONSchema
