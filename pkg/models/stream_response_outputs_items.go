...
// StreamResponseOutputsItems stream response outputs items
// swagger:model streamResponseOutputsItems
...
func (m *StreamResponseOutputsItems) validateCreatedAt(formats strfmt.Registry) error {
...
func (m *StreamResponseOutputsItems) UnmarshalBinary(b []byte) error {
	var res StreamResponseOutputsItems
