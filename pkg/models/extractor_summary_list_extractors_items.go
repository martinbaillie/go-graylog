...
// ExtractorSummaryListExtractorsItems extractor summary list extractors items
// swagger:model extractorSummaryListExtractorsItems
...
func (m *ExtractorSummaryListExtractorsItems) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ExtractorSummaryListExtractorsItems) validateConverters(formats strfmt.Registry) error {
...
func (m *ExtractorSummaryListExtractorsItems) validateMetrics(formats strfmt.Registry) error {
...
func (m *ExtractorSummaryListExtractorsItems) UnmarshalBinary(b []byte) error {
	var res ExtractorSummaryListExtractorsItems
