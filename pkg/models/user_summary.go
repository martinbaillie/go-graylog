...
func (m *UserSummary) validateLastActivity(formats strfmt.Registry) error {
...
func (m *UserSummary) validatePermissions(formats strfmt.Registry) error {
...
func (m *UserSummary) validateRoles(formats strfmt.Registry) error {
...
func (m *UserSummary) validateStartpage(formats strfmt.Registry) error {
