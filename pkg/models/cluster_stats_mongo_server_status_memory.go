...
// ClusterStatsMongoServerStatusMemory cluster stats mongo server status memory
// swagger:model clusterStatsMongoServerStatusMemory
...
func (m *ClusterStatsMongoServerStatusMemory) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ClusterStatsMongoServerStatusMemory) UnmarshalBinary(b []byte) error {
	var res ClusterStatsMongoServerStatusMemory
