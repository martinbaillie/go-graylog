...
// AlertConditionSummary alert condition summary
// swagger:model AlertConditionSummary
...
func (m *AlertConditionSummary) validateCreatedAt(formats strfmt.Registry) error {
