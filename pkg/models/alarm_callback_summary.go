...
// AlarmCallbackSummary alarm callback summary
// swagger:model AlarmCallbackSummary
...
func (m *AlarmCallbackSummary) validateCreatedAt(formats strfmt.Registry) error {
