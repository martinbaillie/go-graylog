...
// IndexRangesResponseRangesItems index ranges response ranges items
// swagger:model indexRangesResponseRangesItems
...
func (m *IndexRangesResponseRangesItems) validateBegin(formats strfmt.Registry) error {
...
func (m *IndexRangesResponseRangesItems) validateCalculatedAt(formats strfmt.Registry) error {
...
func (m *IndexRangesResponseRangesItems) validateEnd(formats strfmt.Registry) error {
...
func (m *IndexRangesResponseRangesItems) UnmarshalBinary(b []byte) error {
	var res IndexRangesResponseRangesItems
