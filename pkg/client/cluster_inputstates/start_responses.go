...
func (o *StartOK) Error() string {
	return fmt.Sprintf("[PUT /cluster/inputstates/{inputId}][%d] startOK  %+v", 200, o.Payload)
}
...
func (o *StartNotFound) Error() string {
	return fmt.Sprintf("[PUT /cluster/inputstates/{inputId}][%d] startNotFound ", 404)
}
