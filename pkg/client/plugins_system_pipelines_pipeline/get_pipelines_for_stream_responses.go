...
func (o *GetPipelinesForStreamReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetPipelinesForStreamOK()
...
func NewGetPipelinesForStreamOK() *GetPipelinesForStreamOK {
	return &GetPipelinesForStreamOK{}
}
...
func (o *GetPipelinesForStreamOK) Error() string {
	return fmt.Sprintf("[GET /plugins/org.graylog.plugins.pipelineprocessor/system/pipelines/connections/{streamId}][%d] getPipelinesForStreamOK  %+v", 200, o.Payload)
}

func (o *GetPipelinesForStreamOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
