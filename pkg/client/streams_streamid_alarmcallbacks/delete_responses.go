...
func (o *DeleteOK) Error() string {
	return fmt.Sprintf("[DELETE /system/inputs/{inputId}/staticfields/{key}][%d] deleteOK ", 200)
}
...
func (o *DeleteNotFound) Error() string {
	return fmt.Sprintf("[DELETE /system/inputs/{inputId}/staticfields/{key}][%d] deleteNotFound ", 404)
}
