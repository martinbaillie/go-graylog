...
func (o *PutSystemAuthenticationConfigReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewPutSystemAuthenticationConfigOK()
...
func NewPutSystemAuthenticationConfigOK() *PutSystemAuthenticationConfigOK {
	return &PutSystemAuthenticationConfigOK{}
}
...
func (o *PutSystemAuthenticationConfigOK) Error() string {
	return fmt.Sprintf("[PUT /system/authentication/config][%d] putSystemAuthenticationConfigOK  %+v", 200, o.Payload)
}

func (o *PutSystemAuthenticationConfigOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
/*PutSystemAuthenticationConfigOKBody put system authentication config o k body
swagger:model PutSystemAuthenticationConfigOKBody
*/
