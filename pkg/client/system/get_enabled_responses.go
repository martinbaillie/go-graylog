...
func (o *GetEnabledOK) Error() string {
	return fmt.Sprintf("[GET /streams/enabled][%d] getEnabledOK  %+v", 200, o.Payload)
}

func (o *GetEnabledOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.StreamListResponse)
