...
func (o *LoggersOK) Error() string {
	return fmt.Sprintf("[GET /system/loggers][%d] loggersOK  %+v", 200, o.Payload)
}

func (o *LoggersOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {

	o.Payload = new(models.LoggersSummary)
