...
// NewLoggersParams creates a new LoggersParams object
// with the default values initialized.
func NewLoggersParams() *LoggersParams {

	return &LoggersParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewLoggersParamsWithTimeout creates a new LoggersParams object
...
// NewLoggersParamsWithContext creates a new LoggersParams object
...
// NewLoggersParamsWithHTTPClient creates a new LoggersParams object
...
/*LoggersParams contains all the parameters to send to the API endpoint
for the loggers operation typically these are written to a http.Request
*/
