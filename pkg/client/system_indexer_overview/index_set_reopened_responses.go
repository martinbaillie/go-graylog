...
func (o *IndexSetReopenedOK) Error() string {
	return fmt.Sprintf("[GET /system/indexer/indices/{indexSetId}/reopened][%d] indexSetReopenedOK  %+v", 200, o.Payload)
}

func (o *IndexSetReopenedOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
