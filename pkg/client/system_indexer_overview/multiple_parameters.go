...
// NewMultipleParams creates a new MultipleParams object
...
// NewMultipleParamsWithTimeout creates a new MultipleParams object
...
// NewMultipleParamsWithContext creates a new MultipleParams object
...
// NewMultipleParamsWithHTTPClient creates a new MultipleParams object
...
/*MultipleParams contains all the parameters to send to the API endpoint
for the multiple operation typically these are written to a http.Request
*/
...
func (o *MultipleParams) WithRequestedIndices(requestedIndices *models.IndicesReadRequest) *MultipleParams {
	o.SetRequestedIndices(requestedIndices)
	return o
}
...
func (o *MultipleParams) SetRequestedIndices(requestedIndices *models.IndicesReadRequest) {
	o.RequestedIndices = requestedIndices
}
...
func (o *MultipleParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.RequestedIndices != nil {
		if err := r.SetBodyParam(o.RequestedIndices); err != nil {
			return err
		}
	}
