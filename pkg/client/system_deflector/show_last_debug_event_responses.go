...
func (o *ShowLastDebugEventReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewShowLastDebugEventOK()
...
func (o *ShowLastDebugEventOK) Error() string {
	return fmt.Sprintf("[GET /system/debug/events/local][%d] showLastDebugEventOK  %+v", 200, o.Payload)
}

func (o *ShowLastDebugEventOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
