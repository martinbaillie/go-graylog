...
func (o *CreateCacheOK) Error() string {
	return fmt.Sprintf("[POST /system/lookup/caches][%d] createCacheOK  %+v", 200, o.Payload)
}

func (o *CreateCacheOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
