...
func (o *SystemStatsOK) Error() string {
	return fmt.Sprintf("[GET /system/stats][%d] systemStatsOK  %+v", 200, o.Payload)
}

func (o *SystemStatsOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
