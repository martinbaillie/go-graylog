...
// NewNetworkStatsParams creates a new NetworkStatsParams object
// with the default values initialized.
func NewNetworkStatsParams() *NetworkStatsParams {

	return &NetworkStatsParams{

		timeout: cr.DefaultTimeout,
	}
}

// NewNetworkStatsParamsWithTimeout creates a new NetworkStatsParams object
...
// NewNetworkStatsParamsWithContext creates a new NetworkStatsParams object
...
// NewNetworkStatsParamsWithHTTPClient creates a new NetworkStatsParams object
...
/*NetworkStatsParams contains all the parameters to send to the API endpoint
for the network stats operation typically these are written to a http.Request
*/
...
func (o *NetworkStatsParams) WithContext(ctx context.Context) *NetworkStatsParams {
	o.SetContext(ctx)
	return o
}
